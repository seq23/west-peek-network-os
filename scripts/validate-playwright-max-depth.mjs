...
const labels = ['Dashboard','Events','Add Person','Capture Studio','Thank-You','Intake Queue','West Peek Network','Touchpoints','Approvals','Notifications','AI Smoke Test','How to Add People','Settings'];
...
console.log(`PLAYWRIGHT MAX DEPTH VALIDATION OK — ${count} mocked UI tests plus live production smoke spec cover sidebar, AI smoke, Settings, auth/session, Sheets, capture, events, intake, approvals, notifications, guardrails, and mobile journeys.`);
