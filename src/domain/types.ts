...
export type IntakeSource = 'gmail_trigger' | 'manual_note' | 'pasted_notes' | 'business_card' | 'notes_screenshot' | 'voice_note' | 'business_card_later' | 'voice_note_later' | 'event_public_form' | 'event_private_note' | 'event_card_upload' | 'event_screenshot' | 'event_voice_note' | 'pitch_lab';
export type CaptureType = 'email_thread' | 'self_email_note' | 'forwarded_email' | 'manual_add' | 'business_card' | 'notes_screenshot' | 'voice_note' | 'thank_you_card' | 'event_public_form' | 'event_private_note' | 'pitch_practice' | 'other';
