...
- [ ] `secrets/network-os.local.env.gpg` is present; it is the repo-authorized encrypted continuity vault.
- [ ] no decrypted Network OS environment or auth state is packaged.
